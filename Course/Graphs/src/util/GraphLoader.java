...
public class GraphLoader {
	 ...
	 * roadType
	 * 
	 * where each line is a segment of a road These road segments are assumed to be
	 * ONE WAY.
	 * 
	 ...
	 *            directed.
	 * @param segments
	 *            The collection of RoadSegments that define the shape of a road.
	 *            These segments are maintained separately from the graph as they
	 *            are only used to display paths.
	 */
	...
	/**
	 * Read in a file specifying route maps between airports. The file contains data
	 * as follows: Airline, AirlineID, Source airport, Source airport ID,
	 * Destination airport, Destination airport ID, Codeshare, Stops, Equipment This
	 * method will only read in nonstop routes (with Stops == 0) Vertices are
	 * airports (labeled with Strings) Edges represent nonstop routes
	 * 
	 * @param filename
	 * @param graph
	 */
	...
	/**
	 * Loads a graph from a file. The file is specified with each line representing
	 * an edge. Vertices are numbered from 0..1-numVertices.
	 * 
	...
	public static void main(String[] args) {
		...
		// To use this method to convert your custom map files to custom intersections
		// files
		// just change YOURFILE in the strings below to be the name of the file you
		// saved.
