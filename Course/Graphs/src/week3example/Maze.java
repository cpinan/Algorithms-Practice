...
public class Maze {
	...
	private List<MazeNode> buildPath(HashMap<MazeNode, MazeNode> parentMap, MazeNode start, MazeNode goal) {
	...
	public List<MazeNode> dfsRefactored(int startRow, int startCol, int endRow, int endCol) { // Initialize
		MazeNode start = cells[startRow][startCol];
		MazeNode goal = cells[endRow][endCol];
