...
/**
 * @author UCSD MOOC Development Team Grader for Module 2, Part 2
 */
public class GraphGrader {
	 ...
	 * 
	 * @param args
	 *            Doesn't use command line parameters
	 */
	...
	public void run() {
		...
		try {
			...
			for (int i = 6; i < 11; i++)
				correctAns.add(i);
			runTest(5, "Star graph - Each 'arm' consists of two undirected edges leading away from 0 (starting at 0)",
					0, correctAns);
